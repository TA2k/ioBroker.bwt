...
systemDictionary = {
  ...
  'OR access via BWT App': {
    en: 'OR access via BWT App',
    de: 'ODER Zugriff über BWT App',
    ru: 'ИЛИ доступ через приложение BWT',
    pt: 'OU acesso via aplicativo BWT',
    nl: 'OF toegang via BWT App',
    fr: 'OU accès via BWT App',
    it: 'OPPURE accesso tramite app BWT',
    es: 'O acceso a través de la aplicación BWT',
    pl: 'LUB dostęp przez aplikację BWT',
    'zh-cn': '或通过 BWT 应用程序访问',
  },
};
